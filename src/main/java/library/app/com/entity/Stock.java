...
public class Stock {
  ...
  /**
   * Construit un Stock à partir de l'entité JStock + la quantité déjà calculée (somme des
   * mouvements IN - OUT), fournie par le service. Il n'existe volontairement aucun
   * constructeur/builder qui accepte une quantity arbitraire sans passer par ce calcul.
   */
